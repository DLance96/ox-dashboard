...
urlpatterns = [
    ...
    url(r'^brother/excuse/(?P<pk>\d+)/delete/$', views.ExcuseDelete.as_view(), name="brother_delete_excuse"),
    url(r'^brother/excuse/(?P<excuse_id>[0-9]+)/edit/$', views.brother_edit_excuse, name="brother_edit_excuse"),
    ...
    url(r'^secretary/event/(?P<pk>\d+)/delete/$', views.ChapterEventDelete.as_view(), name="secretary_delete_event"),
    ...
    url(r'^recruitment-chair/event/(?P<pk>\d+)/delete/$', views.RecruitmentEventDelete.as_view(),
        name="recruitment_c_delete_event"),
