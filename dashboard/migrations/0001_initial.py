# Generated by Django 3.0.7 on 2020-08-23 18:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standing_committee', models.CharField(choices=[('4', 'Unassigned'), ('1', 'Public Relations'), ('2', 'Health and Safety'), ('3', 'Social'), ('0', 'Recruitment')], default='4', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('minutes', models.URLField(blank=True, null=True)),
                ('committee', models.CharField(choices=[('4', 'Alumni Relations'), ('1', 'Public Relations'), ('2', 'Health and Safety'), ('3', 'Social'), ('6', 'Scholarship'), ('0', 'Recruitment'), ('5', 'Membership Development')], max_length=1)),
                ('attendees_brothers', models.ManyToManyField(blank=True, to='dashboard.Brother')),
                ('semester', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dashboard.Semester')),
            ],
            options={
