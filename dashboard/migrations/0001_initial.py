    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operational_committee', models.CharField(choices=[('2', 'Scholarship'), ('3', 'Unassigned'), ('1', 'Membership Development'), ('0', 'Alumni Relations')], default='3', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True)),
                ('minutes', models.URLField(blank=True, null=True)),
                ('committee', models.CharField(choices=[('0', 'Recruitment'), ('2', 'Health and Safety'), ('5', 'Membership Development'), ('3', 'Social'), ('1', 'Public Relations'), ('4', 'Alumni Relations'), ('6', 'Scholarship')], max_length=1)),
                ('attendees_brothers', models.ManyToManyField(blank=True, to='dashboard.Brother')),
                ('semester', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dashboard.semester')),
            ],
            options={
