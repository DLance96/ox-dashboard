    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standing_committee', models.CharField(choices=[('3', 'Social'), ('0', 'Recruitment'), ('1', 'Public Relations'), ('2', 'Health and Safety'), ('4', 'Unassigned')], default='4', max_length=1)),
                ('operational_committee', models.CharField(choices=[('1', 'Membership Development'), ('3', 'Unassigned'), ('0', 'Alumni Relations'), ('2', 'Scholarship')], default='3', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('minutes', models.URLField(blank=True, null=True)),
                ('committee', models.CharField(choices=[('3', 'Social'), ('6', 'Scholarship'), ('0', 'Recruitment'), ('1', 'Public Relations'), ('2', 'Health and Safety'), ('4', 'Alumni Relations'), ('5', 'Membership Development')], max_length=1)),
                ('attendees_brothers', models.ManyToManyField(blank=True, to='dashboard.Brother')),
                ('semester', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dashboard.semester')),
            ],
            options={
